...
namespace HyphyOregonConferences
{
    class Program
    {
        ...
        private static string[] ownerNames()
        {
            ...
            else if(r.IsMatch(ownerNameInput[0]))
            {
            ...
            else if (r.IsMatch(ownerNameInput[1]))
            {
                Console.WriteLine("You entered a special character. Please enter an owner's name in character values only.");
            }
            ...
            else if (r.IsMatch(ownerNameInput[2]))
            {
                Console.WriteLine("You entered a special character. Please enter an owner's name in character values only.");
            }
            ...
            else if (r.IsMatch(ownerNameInput[3]))
            {
                Console.WriteLine("You entered a special character. Please enter an owner's name in character values only.");
            }
            ...
            else if (r.IsMatch(ownerNameInput[4]))
            {
                Console.WriteLine("You entered a special character. Please enter an owner's name in character values only.");
            }
            ...
            else if (r.IsMatch(ownerNameInput[5]))
            {
                Console.WriteLine("You entered a special character. Please enter an owner's name in character values only.");
            }
            ...
            else if (r.IsMatch(ownerNameInput[6]))
            {
                Console.WriteLine("You entered a special character. Please enter an owner's name in character values only.");
            }
            ...
            else if (r.IsMatch(ownerNameInput[7]))
            {
                Console.WriteLine("You entered a special character. Please enter an owner's name in character values only.");
            }
            ...
            else if (r.IsMatch(ownerNameInput[8]))
            {
                Console.WriteLine("You entered a special character. Please enter an owner's name in character values only.");
            }
            ...
            else if (r.IsMatch(ownerNameInput[9]))
            {
                Console.WriteLine("You entered a special character. Please enter an owner's name in character values only.");
            }
